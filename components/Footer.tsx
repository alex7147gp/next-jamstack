      ...
      <div className="max-w-screen-xl mx-auto w-95">
        <Grid container spacing={4}>
          ...
          <Grid item xs={6} sm={3}>
            ...
            <p>
              <a href="https://platzi.com/">{t('PlatziSNext.jsCourseby')}</a>{' '}
              <a href="https://twitter.com/JohnCalle20">@JohnCalle20</a>
            </p>
            <div className="mt-3">
              <a
                href="https://twitter.com/Johncalle20"
                title="Follow @JohnCalle20 on Twitter"
                className="pr-4"
              >
                TW
              </a>
              <a
                href="https://github.com/alex7147gp"
        ...
        <div className="mt-20 border-t-2 border-gray-600 text-gray-600 pt-6 flex justify-between">
          ...
          <p>
            <a target="_blank" href="https://jcshop.shop">
              jcshop.shop
            </a>
          </p>
        </div>
